...
class srcDevDebugProjectContainerUrlGenerator extends Symfony\Component\Routing\Generator\UrlGenerator
{
    ...
    public function __construct(RequestContext $context, LoggerInterface $logger = null, string $defaultLocale = null)
    {
        ...
        if (null === self::$declaredRoutes) {
            self::$declaredRoutes = [
        'form' => [[], ['_controller' => 'App\\Controller\\HomeController::index'], [], [['text', '/form']], [], []],
        'home' => [[], ['_controller' => 'App\\Controller\\HomeController::home'], [], [['text', '/']], [], []],
        'recap' => [['id'], ['_controller' => 'App\\Controller\\HomeController::recap'], [], [['variable', '/', '[^/]++', 'id'], ['text', '/recap']], [], []],
        'infos' => [[], ['_controller' => 'App\\Controller\\HomeController::infos'], [], [['text', '/infos']], [], []],
        'contact' => [[], ['_controller' => 'App\\Controller\\HomeController::contact'], [], [['text', '/contact']], [], []],
        'success' => [['id'], ['_controller' => 'App\\Controller\\HomeController::success'], [], [['variable', '/', '[^/]++', 'id'], ['text', '/success']], [], []],
        'limite_Commande' => [['date'], ['_controller' => 'App\\Controller\\HomeController::limitCommande'], [], [['variable', '/', '[^/]++', 'date'], ['text', '/limitCommande']], [], []],
